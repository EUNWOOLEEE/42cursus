...
/*   Updated: 2023/03/26 18:38:18 by eunwolee         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int stand_img(t_game *game, char *str)
{
	...
	while (coor.row < 2)
	{
		...
		{
			str[22] = coor.col + '0';
			game->stand[coor.row][coor.col].img_ptr = mlx_png_file_to_image(game->mlx, str, 
...
int walk_img(t_game *game, char *str)
{
	...
	while (coor.row < 2)
	{
		...
		{
			str[20] = coor.col + '0';
			game->walk[coor.row][coor.col].img_ptr = mlx_png_file_to_image(game->mlx, str, 
...
int jump_img(t_game *game, char *str)
{
	...
	while (coor.row < 2)
	{
		...
		while (coor.col < 11)
		{
			...
			game->jump[coor.row][coor.col].img_ptr = mlx_png_file_to_image(game->mlx, str, 
	...
	while (coor.row < 2)
	{
		...
		while (coor.col < 14)
		{
			if (coor.col == 10)
				str[20] = '1';
			str[21] = (coor.col % 10) + '0';
			game->rest[coor.row][coor.col].img_ptr = mlx_png_file_to_image(game->mlx, str, 
...
int sleep_img(t_game *game, char *str)
{
	...
	while (coor.row < 2)
	{
		...
		{
			str[22] = coor.col + '0';
			game->sleep[coor.row][coor.col].img_ptr = mlx_png_file_to_image(game->mlx, str, 
